...
class RadioTimeTableController extends Controller
{
    public function index()
{
    $schedules = RadioTimeTable::all();
    return view('dashboard.admin.schedules.index', ['schedules'=> $schedules]);
}
 ...
 * @return \Illuminate\Http\Response
 */
public function show(RadioTimeTable $RadioTimeTable)
{
 ...
 * @return \Illuminate\Http\Response
 */
public function edit(RadioTimeTable $RadioTimeTable)
{
    $TimeTables = RadioTimeTable::all();
    $users = UserProfile::all();
 ...
 * @return \Illuminate\Http\Response
 */
public function update(Request $request, RadioTimeTable $RadioTimeTable)
{
...
public function destroy(RadioTimeTable $RadioTimeTable)
{
$show = RadioShow::findorfail($RadioShow->id);
$show->delete();
$TimeTables = RadioTimeTable::all();
